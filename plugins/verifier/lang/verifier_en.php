...
return [
	...
	'erreur_iban_format' => 'You must provide a valid IBAN.',
	...
	'erreur_regex' => 'The string is incorrectly formatted.',
	'erreur_siren' => 'The SIREN number is invalid.',
	'erreur_siret' => 'The SIRET number is invalid.',
	'erreur_slug' => 'Only lower case alphanumeric characters or "@separateur@".', # RELIRE
	'erreur_slug_longueur_maxi' => '@nb_max@ character(s) maximum (currently @nb@).',
	'erreur_slug_normaliser_suggerer' => 'Try "@valeur@".',
	...
	// N
	'normaliser_option_date' => 'Standardize the date?',
	'normaliser_option_date_aucune' => 'No',
	'normaliser_option_date_en_date' => 'In "Date" format (for SQL)',
	'normaliser_option_date_en_datetime' => '"Datetime" format (for SQL)',
	'normaliser_option_iban' => 'Standardize the IBAN?', # RELIRE
	'normaliser_option_iban_machine' => 'In standard format (no spaces, capitals)',
	...
	'option_decimal_normaliser' => 'Standardize to computer format',
	...
	'option_regex_modele_explication' => 'Full pattern, including enclosing characters and options. For the use of masks, refer to <a href="https://www.php.net/manual/en/reference.pcre.pattern.syntax.php" class="spip_out" target="_blank" rel="noopener noreferrer">the PHP online help</a>.', # RELIRE
	'option_regex_modele_label' => 'Pattern to test', # RELIRE
	...
	'option_slug_longueur_maxi_label' => 'Maximum length ',
	'option_slug_normaliser_explication' => 'Standardize accented characters, punctuation,  etc.<br>Example : " Ô, toi, l’écureuil ! " becomes " o_toi_l_ecureuil "', # RELIRE
	'option_slug_normaliser_label' => 'Normalise the value',
	'option_slug_normaliser_suggerer_explication' => 'By default, standardisation takes place silently in the background. You can make a simple suggestion to keep it in hand.', # RELIRE
	'option_slug_normaliser_suggerer_label' => 'Make one suggestion only.',
	'option_slug_separateur_explication' => 'Character used to separate words.',
	'option_slug_separateur_label' => 'Separator',
	...
	'options_message_erreur_explication' => 'Leave blank to keep the default message.',
	'options_message_erreur_label' => 'Error message if check fails.',
	...
	'type_slug' => 'Computer identifier (slug) ',
	'type_slug_description' => 'A slug is a short text that can be used to describe and identify a resource. It contains only alphanumeric characters or a separator (the "_" character).',
	'type_taille' => 'Size',
	...
	'vider_date_nulle' => 'Empty null dates (e.g. 1/1/1970)',
];
