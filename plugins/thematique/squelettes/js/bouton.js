		...
		switch (type) {
			...
			case 0:
				...
				if ((CCN.idRestreint > 0) && (CCN.typeRestreint != '') && (CCN.typeRestreint != 'travail_en_cours')) {
					this.div_base.innerHTML = "<div id='reponse_plus2' class='bouton_article_plus'><img src='" + CCN.urlRoot + "img/reponse_plus.png' onClick='createReponse(0, " + CCN.idRestreint + ");' title='" + CCN.lang.publier_nouvel_article + "'></div>";
