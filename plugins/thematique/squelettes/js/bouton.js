		...
		switch (type) {
			...
			case 0:
				...
				if ((CCN.idRestreint > 0) && (CCN.typeRestreint != '') && (CCN.typeRestreint != 'travail_en_cours')) {
					this.div_base.innerHTML = "<div id='reponse_plus2' class='bouton_article_plus'><img src='" + CCN.urlRoot + "img/reponse_plus.png' onClick='createReponse(false,0, " + CCN.idRestreint + ");' title='publier un nouvel article'></div>";
