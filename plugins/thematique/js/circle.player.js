...
var CirclePlayer = function (jPlayerSelector, media, options) {
    ...
    this.jq = {};
    $.each(
        cssSelector, function (entity, cssSel) {
...
CirclePlayer.prototype = {
    ...
    _initPlayer: function () {
        ...
        this.player.bind(
            $.jPlayer.event.play + this.eventNamespace, function (event) {
        ...
        this.player.bind(
            $.jPlayer.event.timeupdate + this.eventNamespace, function (event) {
                if (!self.dragging) {
        ...
        this.player.bind(
            $.jPlayer.event.ended + this.eventNamespace, function (event) {
                self._resetSolution();
            }
        );
    },
