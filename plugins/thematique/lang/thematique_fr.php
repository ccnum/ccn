...
return [
	...
	'besoin_daide'					 => 'Besoin d\'aide ?',
	'besoin_dinspi'					 => 'Besoin d\'inspiration ?',
	...
	'etape1_redaction_article'       => 'Rédaction de votre @type_article@',
	...
	'nhesitez_pas'					 => 'N\'hésitez pas à poster un message dans l\'onglet "Discussions".',
	...
	'previsualiser'                  => 'Prévisualiser mon commentaire',
	...
	'modifier_publication'           => 'Modifier votre publication',
	...
	'publier_intro_reponse_mission'  => 'Choisissez un titre et rédigez votre réponse pour cette mission. Vous pourrez la modifier à postériori. Elle sera visible par tous les participants et les visiteurs !',
	'publier_champ_texte_reponse_mission' => 'Réponse',
	'publier_bouton_reponse_mission' => 'Publier ma réponse à la mission',
	'publier_bandeau_ressource'      => 'Publier une ressource',
	'publier_titre_ressource'        => 'Décrivez votre ressource',
	'publier_intro_ressource'        => 'Choisissez un titre à votre ressource et détaillez son contenu aux autres participants. Elle sera visible dans l’espace Ressources par tous les participants et les visiteurs.',
	'publier_champ_texte_ressource'  => 'Description',
	'publier_bouton_ressource'       => 'Publier ma ressource',
	'publier_bandeau_evenement'      => 'Publier un événement',
	'publier_titre_evenement'        => 'Décrivez votre événement',
	'publier_intro_evenement'        => 'Choisissez un titre à votre événement et détaillez de quoi il s’agit. Il sera visible dans l’Agenda pour tous les participants et les visiteurs.',
	'publier_champ_texte_evenement'  => 'Description',
	'publier_bouton_evenement'       => 'Publier mon événement',
	'publier_bandeau_information'    => 'Publier une information',
	'publier_titre_information'      => 'Rédiger votre information',
	'publier_intro_information'      => 'Choisissez un titre et rédigez votre information. Elle sera visible en Salle des pros par tous les participants connectés (hors élèves).',
	'publier_champ_texte_information' => 'Description',
	'publier_bouton_information'     => 'Publier mon information',
	'publier_compteur_caracteres'    => '/ 50 caractères',
	'publier_checklist_phrases_courtes'   => 'Phrases courtes et simples',
	'publier_checklist_eviter_majuscules' => 'Éviter d’écrire en MAJUSCULES',
	'publier_checklist_ajouter_images'    => 'Ajouter des images et vidéos pour donner envie',
	...
	'titre_onglet_salle_des_pros' 	=> 'Message en salle des pros',
	...
	'notif_bouton_lire_message'      => 'Lire le message sur la plateforme',
	'notif_commentaire_sujet'        => 'Nouveau message : @titre@',
	'notif_commentaire_titre_mission' => 'Un nouveau message est disponible pour la Mission n°@numero@ !',
	'notif_commentaire_titre'        => 'Un nouveau message est disponible pour “@titre@” !',
	'notif_commentaire_detail_mission' => '<strong>@auteur@</strong> a posté un nouveau message dans l’espace discussion de la Mission n°@numero@ <strong><em>“@titre@”</em></strong>.',
	'notif_commentaire_detail'       => '<strong>@auteur@</strong> a posté un nouveau message dans l’espace discussion de <strong><em>“@titre@”</em></strong>.',
	'notif_commentaire_reponse_titre' => 'On vient de répondre à votre message !',
	'notif_commentaire_reponse_detail' => 'Suite à votre commentaire, <strong>@auteur@</strong> vous a répondu dans l’espace discussion de <strong><em>“@titre@”</em></strong>.',
	'notif_bouton_repondre_message'  => 'Répondre au message sur la plateforme',
	'notif_bouton_decouvrir_proposition' => 'Découvrez leur proposition sur la plateforme',
	'notif_reponse_sujet'            => 'Nouvelle réponse : @titre@',
	'notif_reponse_titre_mission'    => 'Une classe vient de répondre à la Mission n°@numero@ !',
	'notif_reponse_titre'            => 'Une nouvelle réponse est disponible pour “@titre@” !',
	'notif_reponse_detail_mission'   => '<strong>@classe@</strong> vient de publier sa réponse à la mission <strong><em>“@titre@”</em></strong> lancée par <strong>@intervenant@</strong>.',
	'notif_reponse_detail'           => '<strong>@classe@</strong> vient de publier sa réponse à la mission <strong><em>“@titre@”</em></strong>.',
	'notif_mission_num_court'        => 'Mission n°@numero@',
	'notif_agenda_sujet'             => 'Nouvelle date dans l’Agenda : @titre@',
	'notif_agenda_titre'             => 'Une nouvelle date a été publiée dans l’Agenda !',
	'notif_agenda_detail'            => '<strong>@auteur@</strong> a publié un nouvel élément dans l’espace <strong><em>Agenda</em></strong>.',
	'notif_salle_pros_sujet'         => 'Nouvelle information dans la Salle des Pros : @titre@',
	'notif_salle_pros_titre'         => 'Une nouvelle information vous attend dans la Salle des Pros !',
	'notif_salle_pros_detail'        => '<strong>@auteur@</strong> a publié une information qui peut vous intéresser dans l’espace <strong><em>Salle des pros</em></strong>.',
	'notif_ressource_sujet'          => 'Nouvelle ressource : @titre@',
	'notif_ressource_titre'          => 'Une nouvelle ressource a été partagée avec vous !',
	'notif_ressource_detail'         => '<strong>@auteur@</strong> vous partage une ressource qui peut vous intéresser dans l’espace <strong><em>Ressources</em></strong>.',
