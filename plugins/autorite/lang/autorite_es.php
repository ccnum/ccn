...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'attention_crayons' => '<small><strong>OjO</strong> Los parámetros a continuación solo pueden funcionar si utilizas un plugin que propone una interfaz de edición (como por ejemplo <a href="http://contrib.spip.net/Les-Crayons">los Lápices</a>).</small>',
	...
	'descriptif_2' => '<p>Si desea modificar esta lista, edite el archivo <tt>config/mes_options.php</tt> (o crearlo en caso dado) e indicar la lista de los nombres de usuario de los autores webmasters, de la siguiente forma:</p>
<pre>&lt;?php
  define(
    \'_ID_WEBMESTRES\',
    \'1:5:8\');
...
', # MODIF
	...
	'redacteurs_voir_auteurs' => '<strong>El redactor ve a los autores</strong>: ¿pueden los redactores pueden <strong>ver la lista de autores con sus correos electrónicos</strong> y la página de otros autores en el área privada?',
	'refus_1' => '<p>Sólo l*s webmestres del sitio',
	'refus_2' => 'están autorizados a modificar estos parámetros.</p>
