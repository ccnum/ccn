...
// extrait automatiquement de https://trad.spip.net/tradlang_module/autorite?lang_cible=mg
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'descriptif_2' => '<p>Il est possible d’ajouter des administrateurs à cette liste en leur donnant les droits de webmestre via la page d’édition de l’auteur.</p>
<p>À noter : les webmestres définis de cette manière n’ont plus besoin de procéder à l’authentification par FTP pour les opérations délicates (mise à niveau de la base de données, par exemple).</p>
