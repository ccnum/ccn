...
Tu trouveras la <a href="https://contrib.spip.net/5080" target="_blank" rel="noopener noreferrer">documentation complète de la syntaxe sur SPIP-contrib</a>.', # MODIF
	...
	'option_forcer_select_explication' => 'Si un groupe de mots est sélectionné, par défaut il s’agira d’une saisie radio. Tu peux forcer l’utilisation d’un select.', # MODIF
	...
	'option_onglet_label_case' => 'Afficher sous forme d’onglet.', # MODIF
	...
	'option_pliable_label_case' => 'Le groupe de champs pourra être replié.', # MODIF
	'option_plie_label' => 'Déjà plié',
	'option_plie_label_case' => 'Si le groupe de champs est pliable, il sera déjà plié à l’affichage du formulaire.', # MODIF
