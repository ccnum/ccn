...
// extrait automatiquement de https://trad.spip.net/tradlang_module/notation?lang_cible=mg
...
return [
	...
	'exemple' => 'Distribution des notes (note = @note@, facteur de pondération = @ponderation@) : ',
	...
	'info_etoiles' => 'Ce paramètre vous permet de modifier la valeure maximale de la note (le nombre d’étoiles, entre 1 et 10, et 5 par défaut).',
	'info_etoiles_warning' => 'Attention : vous ne devez pas toucher à ce paramètre une fois la notation engagée car les notes ne seront pas recalculées et cela peut provoquer des incohérences dans la notation...<br />
