...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'acces' => 'Доступ к голосованию', # MODIF
	...
	'exemple' => 'Таблица распределения голосовых коэффициентов (количество звезд = @note@, коэффициент = @ponderation@) : ',
	...
	'info_etoiles' => 'Этот парамеир позволяет изменять к-во звезд в голосовании (по умолчанию - 5). ',
	'info_etoiles_warning' => 'Внимание : Не рекомендуется изменять этот параметр, так как после его изменения пересчет голосов согласно новому значению не произойдет! Таким образом, данные голосование будут искажены. <br /> 
