...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'exemple' => 'توزيع التقييم (القيمة = @note@ ، عامل الترجيح = @ponderation@):', # RELIRE
	...
	'info_etoiles' => 'هذا الإعداد يسمح لك بتغيير الحد الأقصى لقيمة التقييم (عدد النجوم، 1-10، و 5 افتراضيا).<br />', # RELIRE
	'info_etoiles_warning' => 'انتباه : يجب أن لا تلمس هذا الإعداد بعد إجراء تقييم لأنه لن يتم إعادة حساب القيم وهذا يمكن أن يؤدي إلى عدم تناسق في التقييم ...<br />
                    يجب أن يكون هذا الإعداد ثابتًا عند إنشاء التقييمات..', # RELIRE
