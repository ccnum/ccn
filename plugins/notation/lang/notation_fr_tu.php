...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_etoiles' => 'Ce paramètre te permet de modifier la valeur maximale de la note (le nombre d’étoiles, entre 1 et 10, et 5 par défaut).',
	'info_etoiles_warning' => 'Attention : tu ne dois pas toucher à ce paramètre une fois la notation engagée car les notes ne seront pas recalculées et cela peut provoquer des incohérences dans la notation...<br />
