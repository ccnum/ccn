...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'exemple' => 'Score distribution (score = @note@, weighting factor = @ponderation@) : ',
	...
	'info_etoiles' => 'This setting allows you to change the maximum value of the note (the number of stars between 1 and 10, and 5 by default).',
	'info_etoiles_warning' => 'Warning: you should not modify this setting after the scoring to be initiated because the ratings will not be calculated again and this can cause inconsistencies in the scoring ...<br />
