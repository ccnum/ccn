...
return [
	...
	'exemple' => 'Distribución de notas (nota= @note@, factor de ponderación= @ponderation@): ',
	...
	'info_etoiles_warning' => 'Atención: no ha de tocar esta configuración una vez la notación quede comprometida las notas no podrán volver a calcularse y podrían darse incoherencias en la notación...<br />
Esta configuración debe ser fijada una vez para toda la creación de las notas.',
	...
	'info_ip' => 'Para que sea más fácil, la calificación se adjunta a la dirección IP del votante, así se evita dos votos sucesivos en la base de datos, aunque con algunos inconvenientes... en particular si administra votos de autores.<br />
En este caso, se fija la calificación en el identificador del usuario (cuando se registra, por supuesto).<br />
Si desea garantizar una calificación única, limite el voto solo a las personas registradas.',
	'info_methode_id' => 'Verificación de calificación única',
	...
	'info_vote_unique_auteur' => 'Si quieres garantizar una calificación única, limita el voto <b>solo</b> a  personas registradas.',
	'ip' => 'IP',
	...
	'item_methode_id_cookie' => 'Por "cookie"',
	'item_methode_id_hash' => 'Por identificador del navegador',
	'item_methode_id_ip' => 'Por dirección IP',
