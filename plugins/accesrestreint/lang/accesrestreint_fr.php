...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'alerte_table_breves_documents' => '<strong>Attention !</strong> Votre site utilise le plugin <strong>Accès restreint</strong> mais le plugin <strong>Brèves</strong> n’est pas actif : 
		vous courrez le risque d’<strong>afficher des documents</strong> qui étaient en accès réservés jusque là. 
	...
	'alerte_table_breves_forum' => '<strong>Attention !</strong> Votre site utilise le plugin <strong>Accès restreint</strong> mais le plugin <strong>Brèves</strong> n’est pas actif : 
		vous courrez le risque d’<strong>afficher des forums</strong> qui étaient en accès réservés jusque là. 
		Il est conseillé de le réinstaller ou, si vous êtes certain de ne pas l’utiliser, de supprimer définitivement la table spip_breves.',
