...
add_variable(array(
	...
	'format' => _format_CHAINE,
	'defaut' => '"1"',
	'code:strlen(%s)' => "defined('_ID_WEBMESTRES') || define('_ID_WEBMESTRES', %s);",
	'code:!strlen(%s)' => "defined('_ID_WEBMESTRES') || define('_ID_WEBMESTRES', 1);"
));
add_outil(array(
	'id' => 'webmestres',
...
add_outil(array(
	'id' => 'insert_head',
	'code:options' => "\$GLOBALS['spip_pipeline']['affichage_final'] = (isset(\$GLOBALS['spip_pipeline']['affichage_final']) ? \$GLOBALS['spip_pipeline']['affichage_final'] : '') . '|f_insert_head';",
	'categorie' => 'spip'
));
...
add_variables(array(
	...
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_LOGO_MAX_HEIGHT') || define('_LOGO_MAX_HEIGHT', %s);\n"
), array(
	'nom' => 'logo_Wmax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_LOGO_MAX_WIDTH') || define('_LOGO_MAX_WIDTH', %s);\n"
), array(
	'nom' => 'logo_Smax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_LOGO_MAX_SIZE') || define('_LOGO_MAX_SIZE', %s);\n"
), array(
	'nom' => 'img_Hmax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_IMG_MAX_HEIGHT') || define('_IMG_MAX_HEIGHT', %s);\n"
), array(
	'nom' => 'img_Wmax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_IMG_MAX_WIDTH') || define('_IMG_MAX_WIDTH', %s);\n"
), array(
	'nom' => 'img_Smax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_IMG_MAX_SIZE') || define('_IMG_MAX_SIZE', %s);\n"
), array(
	'nom' => 'doc_Smax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_DOC_MAX_SIZE') || define('_DOC_MAX_SIZE', %s);\n"
), array(
	'nom' => 'img_GDmax',
	'format' => _format_NOMBRE,
	'defaut' => 0,
	'code:%s' => "defined('_IMG_GD_MAX_PIXELS') || define('_IMG_GD_MAX_PIXELS', %s);\n"
), array(
	'nom' => 'img_GDqual',
	'format' => _format_NOMBRE,
	'defaut' => 85,
	'code:%s' => "defined('_IMG_GD_QUALITE') || define('_IMG_GD_QUALITE', %s);\n",
	'label' => '@_CS_CHOIX@'
), array(
	'nom' => 'copie_Smax',
	'format' => _format_NOMBRE,
	'defaut' => 16,
	'code' => "defined('_COPIE_LOCALE_MAX_SIZE') || define('_COPIE_LOCALE_MAX_SIZE', %s*1048576);"
));
add_outil(array(
	'id' => 'SPIP_tailles',
...
add_outil(array(
	...
	'distant_pipelines' => _URL_CS_GIT_EXT . (defined('_SPIP30200')
		? 'masquer/-/raw/master/masquer_pipelines.php'
		: 'masquer/-/raw/tags/v0.5.3/masquer_pipelines.php'),
...
add_outil(array(
	...
	'code:spip_options' => '$GLOBALS["cs_ip"] = isset($ip) ? $ip : "";',
	'categorie' => 'securite'
));
...
" . ((!defined('_SPIP20100')) ? "if(!defined('_ECRAN_SECURITE') && @file_exists(\$f=\"" . str_replace('\\', '/', realpath(dirname(__FILE__))) . "/lib/ecran_securite/distant_ecran_securite.php\")) include \$f;" : '')
	...
	'format' => _format_NOMBRE,
	'defaut' => 4,
	'code:%s' => "defined('_ECRAN_SECURITE_LOAD') || define('_ECRAN_SECURITE_LOAD',%s);\n"
));
add_outil(array(
	'id' => 'ecran_securite',
...
add_variables(array(
	...
	'defaut' => 1,
	'code:%s' => "defined('_NO_CACHE') || define('_NO_CACHE',1);" // SPIP >=2.0
));
add_outil(array(
	'id' => 'en_travaux',
...
add_variables(array(
	...
	'format' => _format_NOMBRE,
	'defaut' => 30,
	'code:%s' => "defined('MAX_AUTEURS_PAR_PAGE') || define('MAX_AUTEURS_PAR_PAGE', %s);\n"
), array(
	'nom' => 'auteurs_0',
...
add_outil(array(
	'id' => 'obf_liens',
	'categorie' => 'spip',
	'nom' => _L('Obfusquer des liens'),
	'description' => _L("Met à votre disposition le filtre \"{{obfusquer_liens}}\".\n\nL'obfuscation de liens (type <code><a href=\"page.html\">par ici</a></code>) permet d'empêcher les robots des moteurs de recherche d'accéder à certaines pages, sans modifier le processus de navigation. Cela pourra éviter la transmission de pagerank non désiré vers des pages à moindre intérêt, et guider les robots vers des pages plus pertinentes et riches.\n\nUtilisation :\n- <code>[(#UNEBALISE|obfusquer_liens)]</code> sur une balise,\n- <code>#FILTRE{obfusquer_liens}</code> dans un squelette.\n\nÀ noter : si le Javascript est désactivé sur la page, le lien sera inactif et l’internaute ne pourra donc pas le suivre."),
	'code:options' => 'function obfusquer_liens($texte) { return preg_replace_callback(",<a (.*)href=[\'\"](.*)[\'\"](.*)</a>,Us", function($reg) { return "<span $reg[1]data-obf=\'" . str_rot13($reg[2]) . "\'$reg[3]</span>"; }, $texte ); }',
	'code:js' => "function cs_rot13(s) { return s.replace(/[a-z]/gi,function(c){ return String.fromCharCode((c<='Z'?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26); }); }",
	'code:jq' => '$("[data-obf]").click(function () { window.location = cs_rot13($(this).data("obf")); return false; });',
	'code:css' => '[data-obf] {cursor:pointer; text-decoration:underline;}',
	//'pipelinecode:post_propre' => 'if(strpos($flux, "<a")!==false) $flux=cs_echappe_balises("", "obfusquer_liens", $flux);',
));
...
add_outil(array(
	...
	'categorie' => 'typo-corr',
	'pipelinecode:pre_typo' => 'if(strpos($flux, "-")!==false OR strpos($flux, "*")!==false) $flux = cs_echappe_balises("|cite|jeux", "pucesli_remplace", $flux);',
...
defined('_EXTRAIRE_LIENS') || define('_EXTRAIRE_LIENS',',^\$,');" : ''
), array(
	'nom' => 'long_url',
	'format' => _format_NOMBRE,
	'defaut' => 40,
...
function fct_glossaire_groupes($gr){
	...
	'defaut' => 1,
	'format' => _format_NOMBRE,
	'code:!%s' => "@define('_GLOSSAIRE_ECHAPPER', '|cite|a');"
));
add_outil(array(
	'id' => 'glossaire',
	'categorie' => 'typo-corr',
	...
	'pipelinecode:nettoyer_raccourcis_typo' => '$flux = defined("_CS_SANS_GLOSSAIRE") ? str_replace(_CS_SANS_GLOSSAIRE, "", $flux) : $flux;',
...
if(!function_exists('genie_optimiser')) {
	...
	function genie_optimiser(\$t='foo'){ 
		if(include_spip('optimiser','genie')) {
			optimiser_base_une_table();
			if(defined('_SPIP40000')) optimiser_caches_contextes();
		}
...
add_outil(array(
	...
	'auteur' => 'JLuc chez no-log.org',
	'contrib' => 4800,
	'pipelinecode:pre_description_outil' => 
			defined('_SPIP40100') ? 'if($id=="switchcase") $texte=str_replace(array("quote>"),array("blockquote>"),$texte);' : '', // bug SPIP 4.1 ?
));
...
$cs_temp = defined('_SPIP30000') ? array(
	// SPIP >= 3.0
	//'distant_action' => 'https://git.spip.net/spip/spip/raw/branch/2.1/ecrire/action/charger_plugin.php',
	'distant_action' => 'https://git.spip.net/spip/spip/-/raw/874860660a8b6dca51cc95b15b4224148c17c3ce/ecrire/action/charger_plugin.php',
	//'distant_inc' => 'https://git.spip.net/spip/spip/raw/branch/2.1/ecrire/inc/charger_plugin.php'
	'distant_inc' => 'https://git.spip.net/spip/spip/-/raw/874860660a8b6dca51cc95b15b4224148c17c3ce/ecrire/inc/charger_plugin.php'
) : (defined('_SPIP20100') ? array() : array(
	// SPIP < 2.1
	'version-min' => '1.9300',
	//'distant' => 'https://git.spip.net/spip/spip/raw/branch/2.1/ecrire/genie/mise_a_jour.php'
	'distant' => 'https://git.spip.net/spip/spip/-/raw/874860660a8b6dca51cc95b15b4224148c17c3ce/ecrire/genie/mise_a_jour.php'
));
...
add_outil(array(
	...
	// fichier distant pour le pipeline
	'distant_pipelines' => _URL_CS_GIT_EXT . 'correction_liens_internes/-/raw/master/correction_liens_internes_pipelines.php',
...
add_outil(array(
	...
	'categorie' => 'securite',
	'auteur' => 'Ma&iuml;eul Rouquette',
	'code:css_public' => '.js-sending {opacity:0.25;}',
	'code:jq_public' => 'jQuery(\'form\').submit(function() {
...
add_outil(array(
	'id' => 'left_join',
	'categorie'	=> 'spip',
	'version-min' => '40000', // SPIP 4.0 mini
	'pipeline:pre_boucle' => 'left_join_pre_boucle',
));
