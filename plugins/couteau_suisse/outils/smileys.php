...
function smileys_raccourcis() {
	...
	return _T('couteauprive:smileys:aide', array('liste' => '<b>'.implode('</b>, <b>', $racc).'</b>'));
}
...
// les balises suivantes sont protegees : html|code|cadre|frame|script|cite|acronym
...
function cs_smileys_pre_typo($texte) {
	...
	return cs_echappe_balises('|cite|acronym', 'cs_rempl_smileys', $texte);
}
