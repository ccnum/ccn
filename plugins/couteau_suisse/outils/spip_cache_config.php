...
add_outil(array(
	...
	'code:spip_options' => "%%radio_desactive_cache"
		...
		. "%%%%duree_cache%%%%duree_cache_mutu%%%%"
		. (defined('_SPIP40000') ? 'quota_cache_nb' : 'quota_cache') 
		. "%%%%derniere_modif_invalide%%",
	'categorie' => 'admin',
	'description' =>
		(defined('_SPIP19300')
			? '<:spip_cache:2:><:spip_cache:' . (defined('_SPIP40000') ? '5' : '4') 
		 		. ':><:spip_cache::><:spip_cache:3:> [[%compacte_css%]][[->%compacte_js%]][[->%compacte_prive%]]'
				. (defined('_SPIP20200') ? '[[->%compacte_tout%]]' : '')
			: '<:spip_cache:1:><:spip_cache::>'), // SPIP 1.92
	'pipelinecode:pre_description_outil' => 'if($id=="spip_cache") {
		$tmp_nb = intval(defined("_CACHE_PROFONDEUR_STOCKAGE") ? _CACHE_PROFONDEUR_STOCKAGE : 4);
...
array(
	...
	'radio/ligne' => 2,
	'defaut' => 2,
	'code:%s!=2' => "defined('_NO_CACHE') || define('_NO_CACHE', %s);\n",
), array(
	'nom' => 'duree_cache',
	'format' => _format_NOMBRE,
	'defaut' => "24", // 1 jour
	...
	'format' => _format_NOMBRE,
	'defaut' => "24", // 1 jour
	'code:%s!=24' => "defined('_DUREE_CACHE_DEFAUT') || define('_DUREE_CACHE_DEFAUT', %s*3600);\n",
), array( // SPIP>=4.0
		'nom' => 'quota_cache_nb',
		'format' => _format_NOMBRE,
		'defaut' => 4, // 16^4 fichiers
		'code:%s!=4' => "defined('_CACHE_PROFONDEUR_STOCKAGE') || define('_CACHE_PROFONDEUR_STOCKAGE', min(8, max(%s, 2)));\n",
), array( // SPIP<4.0
		'nom' => 'quota_cache',
		'format' => _format_NOMBRE,
		'defaut' => 10, // 10 Mo
	...
	'defaut' => 0,
	'code:%s' => "defined('_INTERDIRE_COMPACTE_HEAD') || define('_INTERDIRE_COMPACTE_HEAD', 1);\n",
), array(
	'nom' => 'compacte_prive',
	'check' => 'couteauprive:compacte_prive',
	'defaut' => 0,
	'code:%s' => "defined('_INTERDIRE_COMPACTE_HEAD_ECRIRE') || define('_INTERDIRE_COMPACTE_HEAD_ECRIRE', 1);\n",
), array(
	'nom' => 'compacte_css',
