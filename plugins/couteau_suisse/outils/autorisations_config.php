...
add_variables( array(
	...
	'commentaire' => 'couteauprive_T("autorisations_creees")." ".((include_spip(_DIR_CS_TMP."mes_autorisations") && function_exists("autorisations_liste") && $tmp=autorisations_liste())?implode(", ",$tmp):couteauprive_T("variable_vide"))',
));
