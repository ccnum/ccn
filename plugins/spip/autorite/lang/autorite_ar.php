...
<br />لحل هذه المشكلة، يجب التأكد من ان ملف <tt>mes_options.php</tt> (أو ملحق آخر نشط) قد حدد هذه الوظائف.',
	...
	'descriptif_2' => '<p>من الممكن إعطاء امتيازات مشرف او مشرفة لأي مدير او مديرة من خلال صفحة تحرير المؤلف.</p>
<p>ملاحظة : لا يعود المشرفون والمشرفات المحددون بهذه الطريقة يحتاجون إلى التعريف عن أنفسهم بواسطة FTP لتنفيذ العمليات الحساسة (كترقية قاعدة البيانات، مثلاً).</p>
