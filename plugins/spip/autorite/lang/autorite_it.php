...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'auteur_modifie_petition' => '<strong>Autore modera contestazione</strong>: ogni redattore può moderare la contestazione per gli articoli dei quali è l’autore.',
...
<a href=\'http://contrib.spip.net/Autorite\' class=\'spip_out\'>Cf. documentation</a>',
	...
	// E
	'effacer_base_option' => '<small><br />L’opzione raccomandata è «nessuno», l’opzione standard di SPIP è «gli amministratori» (ma sempre a seguito di verifica FTP).</small>',
	'effacer_base_qui' => 'Chi può <strong>cancellare</strong> il database del sito ?',
	'espace_publieur' => 'Spazio di pubblicazione aperto',
	'espace_publieur_detail' => 'Scegliete qui sotto un settore da trattare come spazio di pubblicazione aperto per redattori e /o visitatori registrati (a condizione di avere un’interfaccia, ad esempio i pennarelli, ed un formulario per inviare l’articolo):',
	...
	'espace_wiki_mots_cles_detail' => 'Scegliete qui sotto le parole chiave che attiveranno la modalità wiki, ovvero modificabile da tutti a partire dallo spazio pubblico (a condizione di avere un’interfaccia, per esempio i pennarelli)',
	...
	'redacteur_modifie_article' => '<strong>Redattore modifica proposte</strong>: ogni redattore può modificare un articolo proposto per la pubblicazione, anche se non ne è l’autore.',
	'redacteurs_voir_auteurs' => '<strong>Il redattore vede gli autori</strong> : i redattori possono <strong>vedere l’elenco degli autori con le loro email</strong> e la pagina degli altri autori nell’area riservata?',
