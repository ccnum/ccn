...
Tu trouveras la <a href="https://contrib.spip.net/5080" target="_blank" rel="noopener noreferrer">documentation complète de la syntaxe sur SPIP-contrib</a>.',
	...
	'option_forcer_select_explication' => 'Si un groupe de mots est sélectionné, il s’agira par défaut d’une saisie radio ou checkbox, en fonction du paramètre du groupe de mot clé : <em>"On ne peut sélectionner qu’<b>un seul</b> mot-clé à la fois dans ce groupe."</em>. Tu peux forcer l’utilisation d’un select.',
	...
	'option_info_facultatif_explication' => 'Tu peux modifier l’indication de caractère facultatif par défaut : <i>[Facultatif]</i>. Pour garder l’information par défaut, ne rien mettre.',
	'option_info_facultatif_explication_dev' => 'Ne sert que si l’option globale `obligatoire_defaut` n’est pas activée. Tu peux modifier l’indication de caractère facultatif par défaut : <i>[Facultatif]</i>. Pour garder l’information par défaut, ne rien mettre.',
	'option_info_facultatif_label' => 'Indication du caractère facultatif',
	'option_info_obligatoire_explication' => 'Tu peux modifier l’indication d’obligation par défaut : <i>[Obligatoire]</i>. Pour garder l’information par défaut, ne rien mettre.',
	...
	'saisie_explication_alerte_type_explication' => 'Si besoin, pour l’espace privé uniquement, choisir un type d’alerte parmi ceux proposés par SPIP (notice, error, success, info).',
