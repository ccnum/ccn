...
// fonction générique appelée par ?exec=action_rapide&arg=mon_outil|argument (pipe obligatoire)
// la fonction mon_outil_argument_action_rapide() est apellée après un include_spip('outils/mon_outil_action_rapide')
...
cs_log(" FIN : exec_action_rapide_dist() - Appel maintenant de ajax_retour() pour afficher le formulaire de '$outil'");
		...
		// mettre à jour les fichiers distants d'un outil...
