...
function typo_exposants_installe_dist() {
	...
	$accents = implode('', array_map('caractere_charset', array(224,225,226,228,229,230,232,233,234,235,236,237,238,239,242,243,244,246,249,250,251,252)));
	$typo = array( array(
...
// cette fonction n'est pas appelee dans les balises html echappees : html|code|cadre|frame|script|cite|acronym|etc...
...
function typo_exposants($texte){
	...
	$texte = cs_echappe_balises('|cite|acronym', 'typo_exposants_rempl', $texte);
