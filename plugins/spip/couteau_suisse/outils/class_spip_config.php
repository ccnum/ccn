...
// balise par defaut pour les intertitres
$h3 = cs_niveau_intertitres(true);
...
add_outil(array(
	...
	'pipelinecode:pre_description_outil' => 'if($id=="class_spip")
...
add_variables(array(
	...
	'code:!strlen(%s)' => "\$GLOBALS['debut_intertitre']=\"<h$h3\$GLOBALS[class_spip_plus]>\";\n",
), array(
	'nom' => 'racc_h2',
	'format' => _format_CHAINE,
	'defaut' => defined('_SPIP19300')?"''":"'</h3>'",
	'code:strlen(%s)' => "\$GLOBALS['fin_intertitre']=%s;\n",
	'code:!strlen(%s)' => "\$GLOBALS['fin_intertitre']='</h$h3>';\n",
), array(
	'nom' => 'racc_i1',
	'format' => _format_CHAINE,
	'defaut' => '',
