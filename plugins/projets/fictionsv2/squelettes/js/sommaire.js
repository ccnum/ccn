$(document).ready(function() {
	...
	function showTooltipListeLink(el) {
		...
		var toptooltip = Math.round(offset.top) - hauteur_tooltip;
		var lefttooltip = Math.round(offset.left) - 95;
		$('#liste-tooltip').css('top', toptooltip - 5).css('left', lefttooltip + 2);
	}
