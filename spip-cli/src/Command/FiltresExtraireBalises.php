...
class FiltresExtraireBalises extends Command
{
    protected function configure(): void
    {
        $this
            ...
            ->setDescription(
                'Extrait les balises du type fourni avec l\'option -b. Exemple `spip extraire_balises  -b p` pour extraire les paragraphes',
            )
            ->setAliases(['extraire_balises'])
